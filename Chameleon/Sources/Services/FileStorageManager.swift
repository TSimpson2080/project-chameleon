...
public final class FileStorageManager {
    ...
    public init(baseURL: URL? = nil, fileManager: FileManager = .default) throws {
        ...
        if let baseURL {
            ...
            resolvedBaseURL = fileManager.urls(for: .applicationSupportDirectory, in: .userDomainMask)[0]
        }
    ...
    public func url(for path: String) throws -> URL {
        guard isSafeRelativePath(path) else { throw StorageError.invalidRelativePath }
